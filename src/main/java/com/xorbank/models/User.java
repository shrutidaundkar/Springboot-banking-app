...
public class User {				
	...
	public User(int userid, String firstname, String lastname, String email, String mobile, String dateofbirth,
			String age, String gender, String password, String resetPasswordToken, List<Account> accounts) {
		super();
		this.userid = userid;
	...
	public String toString() {
		return "User [userid=" + userid + ", firstname=" + firstname + ", lastname=" + lastname + ", email=" + email
				...
				+ ", password=" + password + ", resetPasswordToken=" + resetPasswordToken + ", accounts=" + accounts
				+ "]";
	}
